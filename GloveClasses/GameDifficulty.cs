...
namespace GloveClasses
{
    ...
    public class GameDifficulty : IRecordable
    {
        
        // Attributes of Status Class

        private readonly static string Table = "GameDifficulty";
        private string Name;
        private int CurrentStatus;
        private readonly static List<string> Fields = new List<string>() { "DifName", "DifStatus" };
        private readonly List<string> DataSummary = new List<string>();

        // Class Constructors

        public GameDifficulty(string name, int currentStatus)
        {
            SetName(name);
